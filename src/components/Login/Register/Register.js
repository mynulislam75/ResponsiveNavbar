                            ...
                            <div className="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">
                                ...
                                <form className="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                                        ...
                                        <div className="mb-4 md:mr-2 md:mb-0">
                                            ...
                                            <input
                                                className="w-full px-3 py-2 mb-3 text-sm
                                                 leading-tight text-gray-700 border border-red-500 
                                        ...
                                        <div className="md:ml-2">
                                            ...
                                            <input
                                                className="w-full px-3 py-2 mb-3
                                                 text-sm leading-tight text-gray-700 border
                                                  rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                id="c_password"
                                                type="password"
                                                placeholder="******************"
                                        ...
                                        <button
                                            className="w-full
                                             px-4 py-2 font-bold text-white
                                              bg-blue-500 rounded-full hover:bg-blue-700 focus:outline-none focus:shadow-outline"
                                            type="button"
                                        >
                                            Register Account
                                        </button>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <Link className='text-xs font-semibold text-purple-700' to='/login'>Login</Link>
